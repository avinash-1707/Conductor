...
import { approvalDecisionSignal } from "../src/workflows";
import { env } from "../src/env";
import { logger } from "../src/logger";

/**
 * Sends the approvalDecision signal to a suspended contentPipeline run —
...
async function main(): Promise<void> {
  ...
  try {
    ...
    await client.workflow.getHandle(workflowId).signal(approvalDecisionSignal, payload);
